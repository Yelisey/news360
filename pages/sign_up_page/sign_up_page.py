...
class SignUpPage(object):
    ...
    def open_sign_up_form(self):
        ...
        self.app.get_click_element_helper.click_element(self.app.get_config("Start reading button 1"))
    ...
    def sign_up_with_correct_data_and_logout(self):
        self.sign_up("Correct email field", "Correct password field", "Correct confirm password field")
        self.logout()


    def login_with_incorrect_full_data(self):
        self.sign_up("Incorrect email field", "Incorrect password field", "Incorrect confirm password field")
    ...
    def send_data_into_password_field(self):
        self.open_sign_up_form()
        self.app.get_set_value_helper.set_value_field(self.app.get_config("Correct password field"))


    def send_data_into_confirm_password_field(self):
        self.open_sign_up_form()
        self.app.get_set_value_helper.set_value_field(self.app.get_config("Correct confirm password field"))
    ...
    def check_all_error_on_form(self):
        ...
        self.sign_up("Email field with broken mask", "Correct password field", "Correct confirm password field")
